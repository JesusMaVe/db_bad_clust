...
e indices. Es el punto de entrada de la Fase 2.
...
- Solo depende del codigo existente (`OracleConnector`)
...
- Las columnas sin PK/FK/indices quedan con flags `False` (como en las
